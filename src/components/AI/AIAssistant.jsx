    ...
    try {
      ...
      if (parsed.title || parsed.type === "task_draft") {
        ...
        return {
          ...
          text:
            remainingText ||
            "Here is the deliverable spec generated by FlowAI via Gemini 1.5 Flash:",
          task: {
...
const AIAssistant = () => {
  ...
  const handleSendMessage = async (textToSend = input) => {
    ...
    try {
      // First attempt real live Gemini API
      ...
      // Seamless local heuristics fallback
              ...
              <div>
                ...
                <span className="text-[10px] text-zinc-400 flex items-center gap-1.5">
                  ...
                  <span className="text-[9px] text-cyan-400 font-semibold flex items-center gap-0.5">
                    • <Sparkles className="w-2.5 h-2.5 text-cyan-300 inline" /> Gemini 3.6 Flash
                  </span>
                </span>
              </div>
            </div>
